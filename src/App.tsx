...
function App() {
  ...
  return (
    <div className="bg-white delay-[300ms] duration-[600ms] taos:translate-y-[-200px] taos:opacity-0" data-taos-offset="500">
          ...
          <div className="flex lg:flex-1">
            <a href="#" className="flex  items-center">
              <img
                ...
                alt=""
              />
              <span className=" ml-3 text-2xl text-left font-bold tracking-tight text-[#061427]">Timeless Corpore</span>
            </a>
          </div>
      ...
      <div className=" delay-[300ms] duration-[600ms] taos:translate-y-[200px] taos:opacity-0 flex justify-center pt-32">
        <div className="relative isolate px-6 lg:px-8">
          <div className="mx-auto max-w-2xl">
            <div className="hidden sm:mb-8 sm:flex">
              <div className="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                For our sucess projects.{' '}
